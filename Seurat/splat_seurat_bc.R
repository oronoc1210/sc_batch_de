...
# Load data
spl <- readRDS(file="../Data/splatter_6g_3b.Rds")
...
png("spl_seurat_bc_umap_cluster.png")
DimPlot(spl_combined, reduction="umap")
dev.off()

# Save rds
saveRDS(spl_combined, file="spl_seurat_bc.rds")

# UMAP by tech/celltype
png("spl_seurat_bc_umap_cell.png", width=1000)
